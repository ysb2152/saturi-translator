...
→ 규칙 사전으로는 다 담기 어려운 이 다양한 변형을 **모델이 데이터로 학습**한다. 전체 분석은 [data/analysis.md](data/analysis.md), 파인튜닝 설계·근거는 [why_finetune.md](why_finetune.md) 참고.
...
- [x] KoBART 변환 모델 파인튜닝 파이프라인 + 백엔드 연동
